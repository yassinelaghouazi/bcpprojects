...
export class ServicesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.servicesService
      ...
      .subscribe(
        (res: HttpResponse<IServices[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInServices(): void {
    this.eventSubscriber = this.eventManager.subscribe('servicesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IServices[] | null, headers: HttpHeaders, page: number): void {
