...
export class CautionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.cautionService
      ...
      .subscribe(
        (res: HttpResponse<ICaution[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInCautions(): void {
    this.eventSubscriber = this.eventManager.subscribe('cautionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICaution[] | null, headers: HttpHeaders, page: number): void {
